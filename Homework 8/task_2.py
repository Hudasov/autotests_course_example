...
class Trigon:
    ...
    def args(self, arguments):
        try:
            ...
            if len(arguments) != 3:
                raise IndexError(f"Передано {len(arguments)} аргументов, а ожидается 3")
            elif not (arguments[0] + arguments[1] > arguments[2] and arguments[1] + arguments[2] > arguments[0] and
            ...
            # print(f"Передано {len(arguments)} аргументов, а ожидается 3")
            raise
        except Exception:
