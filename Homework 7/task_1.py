...
class Segment:
    ...
    def length(self):
        return round(((self.first_point[0] - self.second_point[0]) ** 2 +
                      (self.first_point[1] - self.second_point[1]) ** 2) ** 0.5, 2)

    def x_axis_intersection(self):
        return self.first_point[0] * self.second_point[0] < 0 or self.first_point[1] * self.second_point[1] < 0
